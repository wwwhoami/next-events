const events = [
  ...
  },
  {
    ...
    performers:
      'DJ LUCK & MC NEAT, NICKY BLACKMARKET, DJ NICKY BLACKMARKET, RATPACK',
    date: 'June 2, 2021',
    time: '8:00 PM EST',
    description:
      "It's looking more and more like we will be seeing events return in the summer! To celebrate this we are arranging a festival experience to say good bye to lock down! We will also be celebrating the fact Zoom Dance is one year old!",
  ...
  },
  {
    ...
    time: '7:00 PM EST',
    description:
      'Who is ready to party? I mean in the middle of the water, a boat with good music and drinks. If thats you then you have made it to the right place.',
  ...
  },
  {
    ...
    time: '10:00 PM EST',
    description:
      'The most diverse dj on the east coast, DJ RNB team up once again to bring you the next installment in the high energy, Jam Concert Live series!',
  ...
  },
  {
    ...
    time: '8:00 PM EST',
    description:
      'With bands from around the UK ready to send the roof into orbit, get ready for the loudest Welsh festival: the inaugural UnMute 2021.',
